...
impl From<confirmed_block::Rewards> for StoredExtendedRewards {
    fn from(rewards: confirmed_block::Rewards) -> Self {
        rewards
            .rewards
            .into_iter()
...
impl From<Reward> for confirmed_block::Reward {
    fn from(reward: Reward) -> Self {
        Self {
            ...
            reward_type: match reward.reward_type {
                None => confirmed_block::RewardType::Unspecified,
                Some(RewardType::Fee) => confirmed_block::RewardType::Fee,
...
impl From<confirmed_block::Reward> for Reward {
    fn from(reward: confirmed_block::Reward) -> Self {
        Self {
            pubkey: reward.pubkey,
            lamports: reward.lamports,
            post_balance: reward.post_balance,
...
impl From<TransactionWithStatusMeta> for confirmed_block::ConfirmedTransaction {
...
impl From<Transaction> for confirmed_block::Transaction {
...
impl From<VersionedTransaction> for confirmed_block::Transaction {
...
impl From<confirmed_block::Transaction> for VersionedTransaction {
    fn from(value: confirmed_block::Transaction) -> Self {
        Self {
            signatures: value
                .signatures
                .into_iter()
...
impl From<LegacyMessage> for confirmed_block::Message {
...
impl From<VersionedMessage> for confirmed_block::Message {
...
impl From<confirmed_block::Message> for VersionedMessage {
    fn from(value: confirmed_block::Message) -> Self {
...
impl From<MessageHeader> for confirmed_block::MessageHeader {
...
impl From<confirmed_block::MessageHeader> for MessageHeader {
    fn from(value: confirmed_block::MessageHeader) -> Self {
        Self {
...
impl From<TransactionStatusMeta> for confirmed_block::TransactionStatusMeta {
    fn from(value: TransactionStatusMeta) -> Self {
        ...
        let err = match status {
            Ok(()) => None,
            Err(err) => Some(confirmed_block::TransactionError {
...
impl From<InnerInstructions> for confirmed_block::InnerInstructions {
...
impl From<confirmed_block::InnerInstructions> for InnerInstructions {
    fn from(value: confirmed_block::InnerInstructions) -> Self {
        Self {
...
impl From<TransactionTokenBalance> for confirmed_block::TokenBalance {
...
impl From<confirmed_block::TokenBalance> for TransactionTokenBalance {
...
impl From<MessageAddressTableLookup> for confirmed_block::MessageAddressTableLookup {
...
impl From<TransactionReturnData> for confirmed_block::ReturnData {
...
impl From<CompiledInstruction> for confirmed_block::CompiledInstruction {
...
impl From<confirmed_block::CompiledInstruction> for CompiledInstruction {
    fn from(value: confirmed_block::CompiledInstruction) -> Self {
        Self {
